...
<div class="container">
  <form action="<?php echo $_SERVER['PHP_SELF']; ?>" method="post">
    To: <input type="text" name="to_user" placeholder="Email Address">
    Subject: <input type="text" name="subject" placeholder="Subject">
    Body: <textarea name="message" placeholder="Your message.." style="height:200px"></textarea>
...
$servername = "mysql1.cs.clemson.edu";
  ...
  $email = mysqli_real_escape_string($conn,$_POST['to_user']);
  $sql = "SELECT userid
          FROM users
          WHERE email='$email';";
  ...
  echo 'alert(Message failed to send. Email doesn\'t exist.)';  //not showing an alert box.
  echo '</script>';
  }

  $sql = "INSERT INTO messages (from_user,to_user,subject,message)
          VALUES ($userid, $touserid, '$subject','$message')";
