...
$servername = "mysql1.cs.clemson.edu";
  ...
  if(isset($_REQUEST['remove']))
  {
    $sql = "DELETE FROM blocklist
            WHERE o_userid=$userid AND b_userid = ". $_REQUEST['cuser'].";";
...
$servername = "mysql1.cs.clemson.edu";
  ...
  $sql = "SELECT fname,lname, email,o_userid, B_UserID
          FROM users join blocklist ON Userid = b_userid
  ...
  if ($result->num_rows > 0) {
    ...
    echo "<tr>";
      ...
      echo "<td><b>Remove from Block List</b></td>";
      echo "</b></tr>";
    while($row = $result->fetch_assoc()) {
      echo "<tr>";
      ...
      echo "<td><form method='post'> <input type='submit' name='remove' value='Remove From Block List'>
            <input type='hidden' name='cuser' value='".$row['B_UserID']."'>
       </form></td>";
      echo "</tr>";
