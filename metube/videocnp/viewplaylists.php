...
if($_SESSION['userid'] == '1' or !isset($_SESSION['userid'])){
  ...
  {
    $sql = "DELETE FROM videoplaylist
            WHERE playlistid = ". $_REQUEST['playlistid'].";";
...
<body>
 <div class="navbar">
  ...
  <a href="createplaylist.php">Create Video Playlist</a>
  <a href="viewplaylists.php">View Video Playlists</a>
...
<?php
  ...
  $sql = "SELECT * from videoplaylist where userid=$userid";
  $result = $conn->query($sql);
  ...
  if ($result->num_rows > 0) {
    ...
    echo "<table border='1'>";
    echo "<tr>";
      echo "<td><b>Playlist Name</b></td>";
      echo "<td><b>Play Playlist</b></td>";
      echo "<td><b>Delete</b></td>";
      echo "</b></tr>";
    while($row = $result->fetch_assoc()) {
      echo "<tr>";
      echo "<td>" . $row['Playlist_Name'] . "</td>";
      echo "<td><a href='playplaylist.php?pid=".$row['playlistid']."'>Play</a></td>";
